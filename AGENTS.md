...
<!-- gentle-ai:setup-trigger -->
## OpenCode Dotfiles — Machine Setup

This repo is a portable OpenCode configuration. On a new machine, the user will say
"setup this machine", "setup", or "instalar en esta máquina".

### Trigger

When the user says any variation of "setup this machine", "setup", "install", or
"instalar en esta/una máquina/computadora/pc":

1. READ `setup/plan.md` first
...
- Do NOT ask for API keys more than once — store in env vars

### After setup completes

Save to Engram:
```markdown
**title**: "Setup complete on {hostname}"
**type**: config
**content**:
  **What**: OpenCode dotfiles installed and configured
  **Where**: C:\Users\{user}\.config\opencode\
  **Learned**: Any gotchas during this specific machine's setup
```
<!-- /gentle-ai:setup-trigger -->
